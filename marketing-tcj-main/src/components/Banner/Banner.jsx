...
import Img13 from "../../assets/13.png"; // Importing new images
    ...
    <>
      <div className="relative">
        ...
        <div id="strategy" className="container relative z-20 py-20">
          ...
          {/* New Section for "Our Case Studies" */}
          <div className="py-20">
            {/* Updated Title */}
            <h2 className="text-4xl xl:text-5xl font-bold text-black/80 text-center mb-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 justify-center">
              <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 1, ease: [0.25, 0.1, 0.25, 1], delay: 0.5 }}
                className="relative p-3 rounded-md shadow-2xl overflow-hidden bg-white/50 border-4 border-gray-800 rounded-lg transition-transform transform hover:scale-105"
              >
                {/* Darker Border Effect */}
                <div className="absolute inset-0 rounded-lg border-4 border-gray-900 z-0" />
                <img
                  src={Img12}
                  alt="Case Study 1"
                  className="object-cover w-full h-full rounded-md relative z-10 shadow-lg"
                />
              </motion.div>
