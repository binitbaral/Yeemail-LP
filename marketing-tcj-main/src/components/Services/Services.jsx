...
const Services = () => {
  ...
  return (
    <div className="relative">
      ...
      <div id="services" className="container relative z-20 py-12 flex flex-col md:flex-row items-center">
        {/* Image section */}
        <motion.div
      ...
      <style jsx>{`
        ...
        .irregular-frame::before {
          ...
          border-radius: 25px; /* Larger curvature */
          z-index: -1; /* Behind the image */
          filter: blur(10px); /* Blurring effect for the background */
        }
